...
export interface VariableDefinitionNodeData extends Node { }

export class VariableDefinitionVueFlowNode implements Node {
    id: string
    type: string
    ...
    constructor(data: VariableDefinitionNodeData) {
        this.id = data.id
        this.type = "define_variable"
        this.data = data.data
